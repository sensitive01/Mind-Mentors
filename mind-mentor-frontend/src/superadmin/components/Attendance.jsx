            ...
            <div className=" p-6" style={{background:"#642b8f"}}>
              <div className="flex items-center justify-between text-white">
                <div className="flex items-center space-x-4">
                  ...
                  <h1 className="text-2xl font-bold">Marketing Associate Attendance</h1>
                </div>
...
// import { Alarm, Attendance, Event, MoreVert, Paid, Person, Timer, Work } from '@mui/icons-material';
// import {
//   Box,
//   Card,
//   CardContent,
...
//                   <Chip label="Absent" color="error" icon={<Person />} />
//                   <Typography variant="h6" ml={1}>
//                     1552
//                   </Typography>
//                 </Box>
...
//               <CardContent>
//                 <Box display="flex">
//                   <Chip label="Present" color="success" icon={<Person />} />
//                   <Typography variant="h6" ml={1}>
//                     1552
//                   </Typography>
//                 </Box>
...
//               <CardContent>
//                 <Box display="flex">
//                   <Chip label="Week Off" color="primary" icon={<Event />} />
//                   <Typography variant="h6" ml={1}>
//                     1552
//                   </Typography>
//                 </Box>
...
//               <CardContent>
//                 <Box display="flex">
//                   <Chip label="Paid Leave" color="info" icon={<Paid />} />
//                   <Typography variant="h6" ml={1}>
//                     1552
//                   </Typography>
//                 </Box>
...
//               <CardContent>
//                 <Box display="flex">
//                   <Chip label="Holiday" color="warning" icon={<Event />} />
//                   <Typography variant="h6" ml={1}>
//                     1552
//                   </Typography>
//                 </Box>
...
//               <CardContent>
//                 <Box display="flex">
//                   <Chip label="Unpaid Leave" color="error" icon={<Paid />} />
//                   <Typography variant="h6" ml={1}>
//                     1552
//                   </Typography>
//                 </Box>
...
//           <Grid item xs={12}>
//             <Card>
//               <CardHeader title="Attendance Status - January 2024" />
//               <CardContent>
...
//           <Grid item xs={12}>
//             <Card>
//               <CardHeader title="Recent Leave Request" />
//               <CardContent>
...
//           <Grid item xs={12}>
//             <Card>
//               <CardHeader title="Overtime History" />
//               <CardContent>
//                 <TableContainer component={Paper}>
//                   <Table>
//                     <TableHead>
