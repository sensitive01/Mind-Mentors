...
import TournamentList from "../../component/parent-component/parent-dashboard/dashboard-components/TournamentList";

const KidTournamnetPage = () => {
...
export default KidTournamnetPage;
