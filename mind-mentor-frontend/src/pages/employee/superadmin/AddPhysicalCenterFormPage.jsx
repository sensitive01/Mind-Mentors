import AddPhysicalCenterForm from "../../../department-components/common-components/physicalcenter/AddPhysicalCenterForm";
...
const AddPhysicalCenterFormPage = () => {
  return (
...
export default AddPhysicalCenterFormPage;
