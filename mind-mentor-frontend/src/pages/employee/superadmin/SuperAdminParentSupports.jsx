...
import ParentTicketList from "../../../department-components/common-components/support/ParentTicketList";



const SuperAdminParentSupports = () => {
  return (
...
export default SuperAdminParentSupports;