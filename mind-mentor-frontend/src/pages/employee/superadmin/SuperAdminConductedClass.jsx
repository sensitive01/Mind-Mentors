import ConductedClassData from "../../../department-components/common-components/classtimetable/ConductedClassData";
...
const SuperAdminConductedClass = () => {
  return (
...
export default SuperAdminConductedClass