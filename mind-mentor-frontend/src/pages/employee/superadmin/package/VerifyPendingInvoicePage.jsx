import PendingInvoiceTable from "../../../../department-components/common-components/package/PendingInvoiceTable";
...
const VerifyPendingInvoicePage = () => {
  return (
...
export default VerifyPendingInvoicePage;