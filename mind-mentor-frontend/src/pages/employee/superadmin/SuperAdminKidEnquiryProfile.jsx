import KidProfile from "../../../department-components/common-components/kidprofile/KidProfile";
...
const SuperAdminKidEnquiryProfile = () => {
  return (
...
export default SuperAdminKidEnquiryProfile;
