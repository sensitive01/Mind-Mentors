...
const OperationDashboardPage = lazy(() =>
  import("./pages/employee/operation-employee/OperationDashboardPage")
);
const SEnquiryFormPage = lazy(() =>
  import("./pages/employee/operation-employee/SEnquiryFormPage")
);

const ListingEnquiries = lazy(() =>
  import("./pages/employee/operation-employee/ListingEnquiries")
);
const ProspectPage = lazy(() =>
  import("./pages/employee/operation-employee/ProspectPage")
);
// import ReferalPage from "./pages/employee/operation-employee/ReferalPage";

const SupportPages = lazy(() =>
  import("./pages/employee/operation-employee/SupportPage")
);
// import MessageStusTrackPage from "./pages/employee/operation-employee/MessageStusTrackPage";
const SupportRequest = lazy(() =>
  import("./pages/employee/operation-employee/SupportRequest")
);
const ScheduleClass = lazy(() =>
  import("./pages/employee/operation-employee/ScheduleClass")
);
const LeavesPage = lazy(() =>
  import("./pages/employee/operation-employee/LeavesPage")
);
const EmpAttendance = lazy(() =>
  import("./pages/employee/operation-employee/EmpAttendance")
);

const Profile = lazy(() =>
  import("./pages/employee/operation-employee/Profile")
);
const InvoicePage = lazy(() =>
  import("./pages/employee/operation-employee/InvoicePage")
);
const StudentReport = lazy(() =>
  import("./pages/employee/operation-employee/StudentReport")
);
const CoachFeedback = lazy(() =>
  import("./pages/employee/operation-employee/CoachFeedback")
);
const LeaveFormPage = lazy(() =>
  import("./pages/employee/operation-employee/LeaveFormPage")
);

const TasksLogs = lazy(() =>
  import("./pages/employee/operation-employee/Logs")
);
// import MyTaskPage from "./pages/employee/operation-employee/MyTaskPage";
const TaskAssignByMePage = lazy(() =>
  import("./pages/employee/operation-employee/TaskAssignByMePage")
);
const TasksPage = lazy(() =>
  import("./pages/employee/operation-employee/TasksPage")
);
const AssigneTaskPage = lazy(() =>
  import("./pages/employee/operation-employee/AssigneTasksPage")
);
const ShowAllEnquiryLogs = lazy(() =>
  import("./pages/employee/operation-employee/ShowAllEnquiryLogs")
);
// import DemoClassShedulePage from "./pages/employee/operation-employee/DemoClassShedulePage";
const AssignDemoClassPage = lazy(() =>
  import("./pages/employee/operation-employee/AssignDemoClassPage")
);
...
const AllowDeductForm = lazy(() =>
  import("./pages/employee/superadmin/AllowDeductForm")
);
const AllowDeductTable = lazy(() =>
  import("./pages/employee/superadmin/AllowDeductTable")
);
const ChessKid = lazy(() => import("./pages/employee/superadmin/ChessKid"));
const SuperadminDashboard = lazy(() =>
  import("./pages/employee/superadmin/SuperadminDashboard")
);
const DocumentsForm = lazy(() =>
  import("./pages/employee/superadmin/DocumentsForm")
);
const DocumentsTable = lazy(() =>
  import("./pages/employee/superadmin/DocumentsTable")
);
const EmployeeForm = lazy(() =>
  import("./pages/employee/superadmin/EmployeeForm")
);
const EmployeeTable = lazy(() =>
  import("./pages/employee/superadmin/EmployeeTable")
);
const ExpenseForm = lazy(() =>
  import("./pages/employee/superadmin/ExpenseForm")
);
const ExpensesTable = lazy(() =>
  import("./pages/employee/superadmin/Expenses")
);
const HolidayTable = lazy(() => import("./pages/employee/superadmin/Holiday"));
const HolidayForm = lazy(() =>
  import("./pages/employee/superadmin/HolidayForm")
);
const NotificationForm = lazy(() =>
  import("./pages/employee/superadmin/NotificationForm")
);
const NotificationTable = lazy(() =>
  import("./pages/employee/superadmin/NotificationTable")
);
const SuperadminParents = lazy(() =>
  import("./pages/employee/superadmin/SuperadminParents")
);
const Participents = lazy(() =>
  import("./pages/employee/superadmin/Participents")
);
const Payroll = lazy(() => import("./pages/employee/superadmin/Payroll"));
const SuperadminAttendanceReport = lazy(() =>
  import("./pages/employee/superadmin/SuperadminAttendanceReport")
);
const SuperadminFeedback = lazy(() =>
  import("./pages/employee/superadmin/SuperadminFeedback")
);
const SuperadminInvoice = lazy(() =>
  import("./pages/employee/superadmin/SuperadminInvoice")
);
const SuperadminKids = lazy(() =>
  import("./pages/employee/superadmin/SuperadminKids")
);
const SuperadminLeaves = lazy(() =>
  import("./pages/employee/superadmin/SuperadminLeaves")
);
const SuperadminLeavesAdd = lazy(() =>
  import("./pages/employee/superadmin/SuperadminLeavesAdd")
);
// import SuperadminLogin from "./superadmin/components/LoginPage";
const SuperadminMessageStusTrackPage = lazy(() =>
  import("./pages/employee/superadmin/SuperadminMessageStusTrackPage")
);
const SuperadminMyAssignTasks = lazy(() =>
  import("./pages/employee/superadmin/SuperadminMyAssignTasks")
);
const SuperadminMyTasks = lazy(() =>
  import("./pages/employee/superadmin/SuperadminMyTasks")
);
const SuperadminProfile = lazy(() =>
  import("./pages/employee/superadmin/SuperadminProfile")
);
const SuperadminPrograms = lazy(() =>
  import("./pages/employee/superadmin/SuperadminPrograms")
);
const SuperadminReferral = lazy(() =>
  import("./pages/employee/superadmin/SuperadminReferal")
);
const SuperadminRenewal = lazy(() =>
  import("./pages/employee/superadmin/SuperadminRenewal")
);
const SuperadminScheduleClass = lazy(() =>
  import("./pages/employee/superadmin/SuperadminScheduleClass")
);
const SuperadminSupport = lazy(() =>
  import("./pages/employee/superadmin/SuperadminSupport")
);
const SuperadminSupportRequest = lazy(() =>
  import("./pages/employee/superadmin/SuperadminSupportRequest")
);
const TournamentsForm = lazy(() =>
  import("./pages/employee/superadmin/Tournaments")
);
const TournamnetsTable = lazy(() =>
  import("./pages/employee/superadmin/TournamnetsTable")
);
const TransactionForm = lazy(() =>
  import("./pages/employee/superadmin/TransactionForm")
);
const TransactionTable = lazy(() =>
  import("./pages/employee/superadmin/TransactionTable")
);
const UserForm = lazy(() => import("./pages/employee/superadmin/UserForm"));
const UsersTable = lazy(() => import("./pages/employee/superadmin/UsersTable"));
const SuperadminAttendance = lazy(() =>
  import("./pages/employee/superadmin/SuperadminAttendance")
);
const SuperAdminEnquiryLogs = lazy(() =>
  import("./pages/employee/superadmin/SuperAdminEnquiryLogs")
);
const SuperAdminTaskAllLogs = lazy(() =>
  import("./pages/employee/superadmin/SuperAdminTaskAllLogs")
);
      ...
      <Router>
        ...
        >
          <Routes>
            ...
            />
            <Route
              path="/kids/class-rooms-live"
              element={<KidLiveClassRoom />}
            />
          ...
          <Route path="/operation/department/assign-demo-class-individually/:classId"  element={<AssignDemoClassIndividualPage />} /> */}
            ...
            />
            <Route
              path="/operation/department/leaves"
              element={<LeavesPage />}
            />
            <Route
            ...
            />
            <Route
              path="/coachScheduleClass/"
              element={<CoachScheduleClass />}
            />
            ...
            <Route
              ...
              element={<CenterInvoicePage />}
            />
            <Route
              path="/centeradmin-tasks/add"
              element={<CenterMyTaskPage />}
            />
            <Route
            ...
            />
            <Route
              path="/centeradmin/referal"
              element={<CenterReferalPage />}
            />
            <Route
            ...
            />
            <Route
              path="/superadminReferrals"
              element={<SuperadminReferral />}
            />
