                            ...
                            <Tooltip title="Add Kids" arrow>
                              <IconButton
                                ...
                                onClick={(e) => {
                                  e.stopPropagation();
                                  navigate(
                                    `/operation/department/assign-demo-class-individually/${enqId}/${classItem.id}`
                                  );
                                }}
                                sx={{
                                  color: customColors.primary,
                    ...
                    <DetailRow>
                      ...
                      >
                        ...
                        <Button
                          ...
                          onClick={() => {
                            navigate(
                              `/operation/department/assign-demo-class-individually/${enqId}/${selectedClass.id}`
                            );
                          }}
...
export default DemoClassIndividualList;
