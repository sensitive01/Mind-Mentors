...
const EnquiryRelatedTaskComponentUI = ({
  ...
  return (
    <div
      className={`fixed inset-y-0 right-0 w-full max-w-lg transform ${
        open ? "translate-x-0" : "translate-x-full"
      } 
    transition-transform duration-300 ease-in-out bg-white shadow-lg flex`}
    >
      <div className="h-full max-w-3xl mx-auto px-3">
        <div className="h-full bg-white rounded-lg shadow-sm flex flex-col">
          ...
          <div className="bg-gradient-to-r from-primary to-purple-500 p-4 rounded-t-lg">
            <div className="flex justify-between items-center">
              ...
              <button
                onClick={() =>
                  (window.location.href = `/${department}/department/list-task-assigned-me`)
                }
                className="bg-white text-primary px-3 py-1.5 rounded text-sm font-medium hover:bg-purple-50"
              >
                View Tasks
              </button>
            </div>
