...
const ProfileView = () => {
  ...
  const initialProfile = {
    name: "Service Delivery mindmentorz",
    role: "Service Delivery Manager at mindmentorz",
    ...
    email: "ServiceDelivery@mindmentorz.com",
    joinDate: "January 2024",
    website: "www.mindmentorz.services",
    bio: "Committed to ensuring seamless and efficient service delivery for clients. Over 10 years of experience in operational excellence, client satisfaction, and service lifecycle management.",
    stats: [
