  ...
  const handleJoinClass = async (e) => {
    ...
    try {
      ...
      const response = await axios.get(
        `https://live.mindmentorz.in/api/class-new/get-class-new/${classId}`
      );
      ...
      const joinResponse = await axios.post(
        `https://live.mindmentorz.in/api/class-new/sign-join-url-new`,
        {
          fullName: kidName,
          meetingID: meetingID,
