...
const ProfileView = () => {
  ...
  const initialProfile = {
    name: "Renewal Associate  mindmentorz",
    role: "Renewal Associate  Manager at mindmentorz",
    ...
    email: "renewalassociate@mindmentorz.com",
    joinDate: "January 2024",
    website: "www.mindmentorz.Renewals",
    bio: "Committed to ensuring seamless and efficient Renewal Associate  for clients. Over 10 years of experience in operational excellence, client satisfaction, and Renewal lifecycle management.",
    stats: [
