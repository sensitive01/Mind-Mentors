...
// import {employeeEmailVerification,operationPasswordVerification} from "../api/Renewal/employee/EmployeeRenewal"
// const LoginPage = () => {
...
const KidsLoginPage = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const hardcodedEmail = "marketingassociate@mindmentorz.com";
            ...
            {step === 1 && (
              <div>
                ...
                <input
                  ...
                  id="email"
                  className="w-full max-w-lg px-4 py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-sky-500"
                  placeholder="marketingassociate@mindmentorz.com"
                  value={email}
                  onChange={(e) => setEmail(e.target.value)}
                  required
                />
