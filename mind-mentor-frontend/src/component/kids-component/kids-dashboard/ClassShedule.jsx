    ...
    <div className="flex items-center">
      {[...Array(5)].map((_, index) => (
        <Star
          ...
          className={`w-4 h-4 ${
            index < Math.floor(rating) ? "text-orange-500" : "text-gray-300"
          }`}
        />
      ))}
          ...
          {classSchedule.map((classItem) => (
            <div
              ...
              className={`${classItem.backgroundColor} rounded-2xl overflow-hidden 
                ...
                border-2 border-orange-200/50 backdrop-blur-sm`}
            >
              {/* Card Header */}
              <div className="p-6">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h2 className="text-xl font-bold mb-1 text-orange-900">{classItem.program}</h2>
                ...
                <p className="text-sm italic text-center mb-4 text-orange-800">{classItem.description}</p>
        ...
        <div className="mt-12 text-center bg-white/80 rounded-2xl p-8 shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
            <div className="p-4 bg-orange-50 rounded-xl">
              ...
              <h4 className="font-bold mb-2 text-orange-900">Strategic Thinking</h4>
              <p className="text-sm text-orange-700">Develop problem-solving skills</p>
            </div>
            <div className="p-4 bg-orange-50 rounded-xl">
              <span className="text-3xl mb-2 block">🤝</span>
              <h4 className="font-bold mb-2 text-orange-900">Social Skills</h4>
              <p className="text-sm text-orange-700">Make friends and learn teamwork</p>
            </div>
            <div className="p-4 bg-orange-50 rounded-xl">
              <span className="text-3xl mb-2 block">🎯</span>
              <h4 className="font-bold mb-2 text-orange-900">Focus & Patience</h4>
              <p className="text-sm text-orange-700">Improve concentration abilities</p>
            </div>
          </div>
        </div>
      </div>
