const ServiceDept = require('../../model/RenewalModel.js');
const leaves = require('../../model/RenewalLeavesModel.js');
const serviceattendance = require('../../model/RenewalAdminAttendanceModel.js');
